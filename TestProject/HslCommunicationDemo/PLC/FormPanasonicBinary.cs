...
namespace OilCommunicationDemo
{
    public partial class FormPanasonicBinary : Form
    {
        ...
        private void button1_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                ...
                if (connect.IsSuccess)
                {
                    ...
                    panel2.Enabled = true;
                    userControlCurve1.ReadWriteNet = panasonic_net;
                }
                else
                {
        ...
        {
            // 读取short变量
            DemoUtils.ReadResultRender( panasonic_net.ReadInt16( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_ushort_Click( object sender, EventArgs e )
        {
            // 读取ushort变量
            DemoUtils.ReadResultRender( panasonic_net.ReadUInt16( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_int_Click( object sender, EventArgs e )
        {
            // 读取int变量
            DemoUtils.ReadResultRender( panasonic_net.ReadInt32( textBox3.Text ), textBox3.Text, textBox4 );
        }
        private void button_read_uint_Click( object sender, EventArgs e )
        {
            // 读取uint变量
            DemoUtils.ReadResultRender( panasonic_net.ReadUInt32( textBox3.Text ), textBox3.Text, textBox4 );
        }
        private void button_read_long_Click( object sender, EventArgs e )
        {
            // 读取long变量
            DemoUtils.ReadResultRender( panasonic_net.ReadInt64( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_ulong_Click( object sender, EventArgs e )
        {
            // 读取ulong变量
            DemoUtils.ReadResultRender( panasonic_net.ReadUInt64( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_float_Click( object sender, EventArgs e )
        {
            // 读取float变量
            DemoUtils.ReadResultRender( panasonic_net.ReadFloat( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_double_Click( object sender, EventArgs e )
        {
            // 读取double变量
            DemoUtils.ReadResultRender( panasonic_net.ReadDouble( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_string_Click( object sender, EventArgs e )
        {
            // 读取字符串
            DemoUtils.ReadResultRender( panasonic_net.ReadString( textBox3.Text, ushort.Parse( textBox5.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        {
            // short写入
            DemoUtils.WriteResultRender( () => panasonic_net.Write( textBox8.Text, short.Parse( textBox7.Text ) ), textBox8.Text );
        }

        private void button21_Click( object sender, EventArgs e )
        {
            // ushort写入
            DemoUtils.WriteResultRender( () => panasonic_net.Write( textBox8.Text, ushort.Parse( textBox7.Text ) ), textBox8.Text );
        }
        ...
        {
            // int写入
            DemoUtils.WriteResultRender( () => panasonic_net.Write( textBox8.Text, int.Parse( textBox7.Text ) ), textBox8.Text );
        }

        private void button19_Click( object sender, EventArgs e )
        {
            // uint写入
            DemoUtils.WriteResultRender( () => panasonic_net.Write( textBox8.Text, uint.Parse( textBox7.Text ) ), textBox8.Text );
        }

        private void button18_Click( object sender, EventArgs e )
        {
            // long写入
            DemoUtils.WriteResultRender( () => panasonic_net.Write( textBox8.Text, long.Parse( textBox7.Text ) ), textBox8.Text );
        }
        ...
        {
            // float写入
            DemoUtils.WriteResultRender( () => panasonic_net.Write( textBox8.Text, float.Parse( textBox7.Text ) ), textBox8.Text );
        }

        private void button15_Click( object sender, EventArgs e )
        {
            // double写入
            DemoUtils.WriteResultRender( () => panasonic_net.Write( textBox8.Text, double.Parse( textBox7.Text ) ), textBox8.Text );
        }
        ...
        {
            // string写入
            DemoUtils.WriteResultRender( () => panasonic_net.Write( textBox8.Text, textBox7.Text ), textBox8.Text );
        }
        ...
        private void thread_test2( )
        {
            ...
            while (count > 0)
            {
                if (!panasonic_net.Write( "D100", (short)1234 ).IsSuccess) failed++;
                if (!panasonic_net.ReadInt16( "D100" ).IsSuccess) failed++;
                count--;
            }
            thread_end( );
        }
        ...
        private void button4_Click( object sender, EventArgs e )
        {
            ...
            OperateResult runResult = panasonic_net.RemoteRun( );
        ...
        private void button5_Click( object sender, EventArgs e )
        {
            ...
            OperateResult runResult = panasonic_net.RemoteStop( );
            if (runResult.IsSuccess)
            {
        ...
        {
            // 读取型号 -> Read Plc Type
            OperateResult<string> readResult = panasonic_net.ReadPlcType( );
