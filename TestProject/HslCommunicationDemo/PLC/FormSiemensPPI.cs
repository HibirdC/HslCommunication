    ...
    public partial class FormSiemensPPI : Form
    {
        ...
        private void button1_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                ...
                userControlCurve1.ReadWriteNet = siemensPPI;
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button23_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                ...
                DemoUtils.WriteResultRender( siemensPPI.WriteByte( textBox8.Text, byte.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button22_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                DemoUtils.WriteResultRender( siemensPPI.Write( textBox8.Text, short.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button21_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                DemoUtils.WriteResultRender( siemensPPI.Write( textBox8.Text, ushort.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button20_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                DemoUtils.WriteResultRender( siemensPPI.Write( textBox8.Text, int.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button19_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                DemoUtils.WriteResultRender( siemensPPI.Write( textBox8.Text, uint.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button18_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                DemoUtils.WriteResultRender( siemensPPI.Write( textBox8.Text, long.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button17_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                DemoUtils.WriteResultRender( siemensPPI.Write( textBox8.Text, ulong.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button16_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                DemoUtils.WriteResultRender( siemensPPI.Write( textBox8.Text, float.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button15_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                DemoUtils.WriteResultRender( siemensPPI.Write( textBox8.Text, double.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button14_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                DemoUtils.WriteResultRender( siemensPPI.Write( textBox8.Text, textBox7.Text ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
